...
describe('Traveller', function() {
  ...
  it('should be able to get the journeys start locations', function() {
    ...
    assert.deepStrictEqual(traveller.getJourneyStartLocations()[0], "linlithgow");
  });
  ...
  it('should be able to get the journeys end locations', function() {
    ...
    assert.deepStrictEqual(traveller.getJourneyEndLocations()[0], "stirling");
  });
  ...
  it('should be able to get journeys by transport', function() {
    ...
    assert.deepStrictEqual(traveller.getJourneysByTransport('train'), journey1);
  });
  ...
  it('should be able to get journeys over a certain distance', function() {
    ...
    assert.deepStrictEqual(traveller.getJourneysByMinDistance(1000), journey3);
  });
